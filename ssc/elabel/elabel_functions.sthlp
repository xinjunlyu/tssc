...
{p 10 10 2}
{{it:{help elabel##elblnamelist:elblnamelist}} | {varlist}}
...
{helpb elabel_define:elabel define} or 
{helpb elabel_variable:elabel variable}; used with the former, 
functions define new or modify existing value labels; used with 
the latter, functions manipulate variable labels.
