...
if "`info'"!="" {
qui {
	mat _tab_rels = `wiodn', 2000, 2014 \ `tivan', 2005, 2015 \ `eora' , 1990, 2015 \ `wiodo', 1995, 2011 \ `tivao', 1995, 2011
	mat rownames _tab_rels = "wiodn" "tivan" "eora" "wiodo" "tivao"
...
program define ParseICIOTable
	...
	local 0 ", `table'"
	syntax [, WIODO WIODN TIVAO TIVAN EORA USER]

	local wc : word count `wiodo' `wiodn' `tivao' `tivan' `eora' `user'
