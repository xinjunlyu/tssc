...
{cmd:xtoos_t} {depvar} [{indepvars}] [{it:if}], 
	[{opt ind:ate(string)}] [{opt cd:ate(string)}] [{opt m:et(string)}] [{opt mc:omp(string)}] [{opt ev:alopt(varname)}] 
...
Use of {cmd:xtoos_t} including lags of the dependent variable in the specification

{p 4 8 2}{cmd:. xtoos_t invest market stock, indate(15) cdate(20) lags(1)}{p_end}
{p 4 8 2}{cmd:. xtoos_t invest market stock, indate(15) cdate(20) lags(1/3)}{p_end}
